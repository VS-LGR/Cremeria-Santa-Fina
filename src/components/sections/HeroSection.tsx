...
import royalOverlay from "@/assets/aiCremaria_WebCremaria_Web.png";
  ...
  return (
    ...
    >
      ...
      <Image
        ...
        alt=""
        aria-hidden
        className="pointer-events-none absolute inset-0 h-full w-full object-cover object-right-top [filter:drop-shadow(16px_0_42px_rgba(14,21,34,0.58))_drop-shadow(-10px_0_28px_rgba(12,18,28,0.42))_drop-shadow(0_0_56px_rgba(20,29,42,0.38))_drop-shadow(0_0_2px_rgba(242,216,178,0.22))]"
      />
      ...
      <div className="relative z-10 grid w-full items-center gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-14">
        <div className="space-y-6 lg:space-y-7">
          <Badge>{heroContent.eyebrow}</Badge>
          <Heading as="h1" className="max-w-2xl text-white [text-shadow:0_2px_20px_rgba(8,14,24,0.6)]">
            {heroContent.title}
          </Heading>
          <p className="max-w-2xl text-[15px] leading-relaxed text-brand-light sm:text-lg [text-shadow:0_2px_14px_rgba(8,14,24,0.45)]">
        ...
        <div className="w-full max-w-[280px] justify-self-center self-start overflow-hidden rounded-[24px] border border-brand-gold/45 bg-brand-navy-deep/62 p-2 shadow-[0_16px_34px_rgba(12,20,34,0.5)] backdrop-blur-[2px] sm:max-w-[330px] sm:p-2.5 lg:max-w-[350px] lg:justify-self-end lg:-translate-y-10">
          <Image
            src={logoWordmark}
